...
The above code removes `Segment` objects \"0\" and \"1\" since they
...
The above output shows that the `get_segments_before` function filtered
...
The `get_segment_name_dict` function returns a dictionary whose keys are
